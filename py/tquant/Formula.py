...
def SMA_L(DF_IN, DF_OUT, N, M, X=1):
    """
    :param DF_IN:   输
    :param DF_OUT:  输出的 SMA Dataframe格式 index='date'  ,sma
        如果DF_OUT有内容，则不必从头算，如果DF_OUT没有内容，则直接调用 SMA(DF,N,M)
    :param N:
    :param M:
    :param X: 要计算最后X个SMA值
    :return:
